...
export const RowSkeleton: React.FC = () => (
  <div className="mb-8 md:mb-12 pl-4 md:pl-12">
    {/* Section Title */}
    <div className="h-6 md:h-8 w-32 md:w-48 bg-white/10 rounded-md mb-4 md:mb-6" />
...
export const HeroSkeleton: React.FC = () => (
    <div className="relative h-[70vh] md:h-[85vh] w-full mb-8 bg-slate-900/50 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent" />
        
        <div className="relative z-10 h-full flex flex-col justify-end pb-12 md:pb-24 px-6 md:px-12 max-w-4xl">
            {/* Title Placeholder */}
            <div className="h-10 md:h-20 w-3/4 md:w-2/3 bg-white/10 rounded-xl mb-6 md:mb-8" />
            ...
            <div className="flex gap-4">
                <div className="h-12 w-32 md:h-14 md:w-40 bg-white/10 rounded-lg" />
                <div className="h-12 w-32 md:h-14 md:w-40 bg-white/5 rounded-lg" />
            </div>
        </div>
    </div>
);
    ...
    <div className="relative z-10 min-h-screen px-4 md:px-20 pt-20 md:pt-24 pb-20">
      <div className="flex flex-col lg:flex-row gap-8 md:gap-12">
        ...
        <div className="w-full lg:w-1/4 flex flex-col gap-6 md:gap-8">
          <div className="aspect-[2/3] w-2/3 mx-auto lg:w-full bg-white/5 rounded-xl border border-white/5" />
        ...
        <div className="w-full lg:w-3/4 flex flex-col items-center lg:items-start pt-4">
          <div className="h-10 md:h-16 w-3/4 bg-white/10 rounded-xl mb-6" />
