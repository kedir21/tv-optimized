...
const Profile: React.FC = () => {
  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 pt-24 pb-24 md:px-12 md:pt-16 md:pb-28">
      <Meta
        title="User Profile"
        description="Manage your K-Flix account, view your watchlist statistics, and update your preferences."
      />
      <div className="max-w-4xl mx-auto">
        <header className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 mb-12">
          {/* Avatar */}
          <div className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-br from-red-600 to-red-900 flex items-center justify-center shadow-2xl border-4 border-slate-900 ring-2 ring-white/10" aria-label={`Avatar for ${user.username}`}>
        ...
        {/* Stats Grid */}
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12" aria-label="Account statistics">
          ...
          <div className="bg-white/5 border border-white/5 rounded-2xl p-6 flex flex-col items-center justify-center hover:bg-white/10 transition-colors cursor-pointer group" tabIndex={0} role="button" aria-label="Account settings">
        ...
        <section className="bg-gradient-to-r from-red-900/20 to-transparent border-l-4 border-red-600 p-6 rounded-r-lg" aria-label="Membership information">
