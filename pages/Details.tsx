...
const Details: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-red-600 font-sans overflow-x-hidden">
      ...
      {/* Main Content Container - Everything wrapped in one centered div */}
      <div className="relative z-30 min-h-screen flex flex-col">
        <div className="flex-1 w-full max-w-[1920px] mx-auto px-3 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
          <div className="pt-4 sm:pt-8 lg:pt-12 pb-8 sm:pb-16 lg:pb-32">
        ...
        {/* Recommendations Section - Now properly contained within the centered wrapper */}
        {recommendations.length > 0 && (
          <div className="border-t border-white/10">
            <div className="w-full max-w-[1920px] mx-auto px-3 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
